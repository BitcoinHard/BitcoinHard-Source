...
This document provides guidelines for internationalization of the BitcoinHard Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinhard_en.ts` remains unchanged.
