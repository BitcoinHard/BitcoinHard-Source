...
This mechanism has been integrated into Bitcore-Node-BitcoinHard which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitcoinhardpay/insight-api-bitcoinhard#web-socket-api](https://github.com/bitcoinhardpay/insight-api-bitcoinhard#web-socket-api)
* API: [https://github.com/bitcoinhardpay/insight-api-bitcoinhard#instantsend-transactions](https://github.com/bitcoinhardpay/insight-api-bitcoinhard#instantsend-transactions)
...
By default, the BitcoinHard Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BitcoinHard Core daemon:
