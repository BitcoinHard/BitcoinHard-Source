...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid bitcoinhard address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid bitcoinhard address" in e.error['message'])
