...
2. run bitcoinhardd with -printalert or -sendalert like this:
   /path/to/bitcoinhardd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.bitcoinhard.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/BitcoinHard Core:0.12.0.58/"));
