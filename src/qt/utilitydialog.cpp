    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  bitcoinhard-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the BitcoinHard in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BTCHD, 0.1 BTCHD, 1 BTCHD and 10 BTCHD -- sort of like the paper money you use every day.</li> \
