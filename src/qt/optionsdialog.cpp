    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BTCHD-light"), QVariant("light"));
    ui->theme->addItem(QString("BTCHD-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BTCHD-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("BTCHD-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("BTCHD-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BTCHD-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BTCHD-traditional"), QVariant("trad"));
