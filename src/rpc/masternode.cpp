...
UniValue masternode(const JSONRPCRequest& request)
{
    ...
    if (strCommand == "outputs") {
        ...
        pwalletMain->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_6250);
...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print BitcoinHard address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "bitcoinhard",               "masternode",             &masternode,             true,  {} },
    { "bitcoinhard",               "masternodelist",         &masternodelist,         true,  {} },
    { "bitcoinhard",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "bitcoinhard",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "bitcoinhard",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "bitcoinhard",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
